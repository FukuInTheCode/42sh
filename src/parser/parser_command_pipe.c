...
static int set_next(parser_t *parser, command_t *pipeline)
{
    command_t *next = NULL;
    ...
    command_add(pipeline, next);
    return 0;
}

command_t *parser_command_pipe(parser_t *parser)
{
    command_t *ret = NULL;
    char **argv = NULL;
